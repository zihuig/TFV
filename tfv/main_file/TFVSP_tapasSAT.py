...
parser.add_argument('--intermediate_epoch',
                    type=int,
                    default=5)
...
class TFVSP:
    ...
    def fit_table_entailment(self, pretrain_mode, intermediate_mode, finetune_mode, output_path, intermediate_epoch):
        ...
        if pretrain_mode == "bert":
            ...
            self.intermediate_model = "/home/cmk/fact/TFVSP/train_model/intermediate/Ptapas/sat_mlm_cells/epoch_"+str(intermediate_epoch)+".pt"
...
if __name__ == '__main__':
    ...
    tfvsp.fit_table_entailment(args.pretrain_mode, args.intermediate_mode, args.finetune_mode, args.output_path, args.intermediate_epoch)
